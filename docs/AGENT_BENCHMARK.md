...
- Task state is currently process-local, not durable task files with blockers/owners/watchers.
...
- Benchmarks need to grade tool behavior, not only final artifacts.
